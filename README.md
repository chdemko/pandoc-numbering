...
[![Coveralls](https://img.shields.io/coveralls/github/chdemko/pandoc-numbering/3.4.0.0.svg?logo=Codecov&logoColor=white)](https://coveralls.io/github/chdemko/pandoc-numbering?branch=3.4.0.0)
...
[![Docs](https://img.shields.io/readthedocs/pandoc-numbering.svg?logo=read-the-docs&logoColor=white)](http://pandoc-numbering.readthedocs.io/en/3.4.0.0/)
...
See the [Read the docs pages](http://pandoc-numbering.readthedocs.io/en/3.4.0.0/).
