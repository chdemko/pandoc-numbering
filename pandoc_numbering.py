...
class Numbered(object):
    ...
    def _compute_data(self):
        ...
        if self._title:
            ...
            # Check for numbering; if it exists, title appearance should be modified
            if self._local_number is not None:
                # Format title without parentheses and italics and insert a colon before it
                del self._get_content()[1].content[1:]
                self._get_content()[1].content[0].content.extend([Str(":"), Space(), Str("%T")])
